...
export default async function Hero() {
  ...
  return (
    <section className="relative flex min-h-[85vh] flex-col justify-center overflow-hidden pt-20 pb-16 sm:pt-24 sm:pb-20 md:pt-28 md:pb-24">
      <StarField />
      <div className="section-container relative z-10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="animate-fade-in animate-fade-in-delay-1 mx-auto mt-6 max-w-[90%] text-base leading-[1.65] text-[var(--text-secondary)] sm:mt-7 sm:max-w-[80%] sm:text-[1.0625rem] sm:leading-[1.7] lg:max-w-[70%]">
            {t("subheadline")}
          </p>
